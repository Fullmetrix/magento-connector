...
use Magento\Framework\Model\ResourceModel\Db\VersionControl\Snapshot as EntitySnapshot;
...
class EntitySerializer
{
    ...
    public function __construct(
        ...
        private readonly EntitySnapshot $entitySnapshot,
    ) {
    }

    /**
     * Releases the snapshots Magento keeps for every sales entity loaded by the previous page.
     *
     * @return void
     */
    public function releaseLoadedEntities(): void
    {
    ...
    {
        $order = $this->orderFactory->create()->load((int) $creditmemo->getOrderId());
