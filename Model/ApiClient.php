...
class ApiClient
{
    ...
    /**
     * Tells whether the storefront tracker is enabled, from the last configuration the cron pulled.
     *
     * The storefront never waits on the network: the configuration is refreshed by the cron only.
     *
     * @return bool
     */
    public function isTrackerEnabled(): bool
    {
        $pluginConfig = $this->config->getStalePluginConfig();
